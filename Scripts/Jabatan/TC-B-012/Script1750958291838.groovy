...
WebUI.setText(findTestObject('Object Repository/Jabatan/input_Admin Hadir_search'), '66')

WebUI.click(findTestObject('Object Repository/Jabatan/button_Search'))

WebUI.click(findTestObject('Object Repository/Jabatan/button_Khusus Delete_MuiButtonBase-root Mui_d5527d'))

WebUI.click(findTestObject('Object Repository/Jabatan/li_Delete'))

WebUI.click(findTestObject('Object Repository/Jabatan/button_Ya'))
