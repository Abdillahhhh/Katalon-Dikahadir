...
WebUI.click(findTestObject('Object Repository/Jabatan/button_Jangan Dihapus_MuiButtonBase-root Mu_dbf530'))

WebUI.click(findTestObject('Object Repository/Jabatan/li_Edit'))

WebUI.setText(findTestObject('Object Repository/Jabatan/input_Nama Jabatan_name'), 'Jangan Dihapus ya')

WebUI.setText(findTestObject('Object Repository/Jabatan/input_Level Jabatan_level'), '92')
