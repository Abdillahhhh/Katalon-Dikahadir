...
'isi tanggal baru'
WebUI.sendKeys(findTestObject('Jadwal/Tambah Jadwal/Alert/input_Tanggal Effective'), '01/10/2021')
...
WebUI.setText(findTestObject('Jadwal/Tambah Jadwal/input_ToleransiKeterlambatan'), '2')
...
TestObject errorTooltip = findTestObject('Object Repository/Jadwal/Tambah Jadwal/Hari Kerja/input_NamaJadwal' // Ganti dengan TestObject yang menunjuk ke elemen error-nya
    )
