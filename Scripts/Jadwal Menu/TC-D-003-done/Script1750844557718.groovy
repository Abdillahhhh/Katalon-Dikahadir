...
'isi tanggal baru'
WebUI.sendKeys(findTestObject('Jadwal/Tambah Jadwal/Alert/input_Tanggal Effective'), '10/20/2023')

WebUI.delay(1)

WebUI.setText(findTestObject('Jadwal/Tambah Jadwal/Hari Kerja/input_NamaJadwal'), 'a2testing2')
